...
export const DATA_RECORDER_TOOLS: ToolCreatorPayload[] = [
    ...
    },
    {
        ...
        parameters: [
            ...
            { name: 'rctProtocol', type: 'object', description: 'The minimal viable RCT protocol generated by the agent.', required: false },
        ...
        implementationCode: `
            const { synergyData, noveltyClass, riskDossier, commercializationOutlook, rctProtocol, version, history, backgroundSources } = args;
